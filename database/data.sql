...
INSERT INTO "address"
    ("id", "clients_id", "street", "city", "state", "zip", "business", "home", "current")
VALUES
    ('1', '1', '215th Court', 'Peculiar', '64078', 'Burple Interprises', 'true', 'true');

INSERT INTO "competitions"
    ("date of", "name")
VALUES
    ('2020-03-10', 'Dane Pherigo');

INSERT INTO "clients_competitions"
    ("id", "clients_id", "competitions_id", "statusNum", "award", "notes")
VALUES
    ('1', '1', '1', '1', 'Congrats', 'You are awewsome!');
...
016:00:00', '2020-02-10 018:00:00', 2020-02-10, 'Back To Business', 'Get ready to change lives', 'Prime Digital Academy');

INSERT INTO "survey"
    ("clients_id", "businessStarted", "revenue", "date")
VALUES
    (1, 1, 25000, 2020-03-11);

INSERT INTO "events_client"
